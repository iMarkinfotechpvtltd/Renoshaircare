...
add_image_size( 'home_banner_size', 1920, 972,true);
add_image_size( 'about_image_size', 635, 643,true );
add_image_size( 'brand_image_size', 178, 52,true );
add_image_size( 'gallery_banner_image_size', 1360, 627,true);
add_image_size( 'gallery_thumb_image_size', 191, 180,true );
add_image_size( 'blog_image_size', 460, 330,true );
add_image_size( 'blog_single_image_size', 1440, 607,true );
add_image_size( 'location_image_size', 460, 307,true );
add_image_size( 'service_single_image_size', 704, 505,true );
...
add_action( 'init', 'add_homebanner_post_type' );
function add_homebanner_post_type() {
	$labels = array(
		'name'               => _x( 'Home Slider', 'post type general name', 'your-plugin-textdomain' ),
		...
		'add_new'            => _x( 'Add Home Slider', 'Service', 'your-plugin-textdomain' ),
		...
		'all_items'          => __( 'All Home Slider', 'your-plugin-textdomain' ),
		'search_items'       => __( 'Search Home Slider', 'your-plugin-textdomain' ),
		'parent_item_colon'  => __( 'Parent Home Slider:', 'your-plugin-textdomain' ),
		'not_found'          => __( 'No Home Slider found.', 'your-plugin-textdomain' ),
		'not_found_in_trash' => __( 'No Home Slider found in Trash.', 'your-plugin-textdomain' )
	);
	...
	$args = array(
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite'            => array( 'slug' => 'home_slider_post' ),
	...
	register_post_type( 'home_slider_post', $args );
}
// ***************************** HOME BANNER POST TYPE ****************************************//
...
function add_testimonials_post_type() {
	$labels = array(
		...
		'add_new'            => _x( 'Add Testimonials', 'Service', 'your-plugin-textdomain' ),
...
// ***************************** BRANDs POST TYPE ****************************************//
add_action( 'init', 'add_brand_post_type' );
function add_brand_post_type() {
	$labels = array(
		...
		'add_new'            => _x( 'Add Brand', 'Service', 'your-plugin-textdomain' ),
	...
	register_post_type( 'brand_post', $args );
}
...
function add_gallery_post_type() {
	$labels = array(
		...
		'add_new'            => _x( 'Add Gallery', 'Service', 'your-plugin-textdomain' ),
	...
	$args = array(
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite'            => array( 'slug' => 'gallery_post' ),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function add_location_post_type() {
	$labels = array(
		'name'               => _x( 'Location', 'post type general name', 'your-plugin-textdomain' ),
		'singular_name'      => _x( 'Location', 'post type singular name', 'your-plugin-textdomain' ),
		'menu_name'          => _x( 'Location', 'admin menu', 'your-plugin-textdomain' ),
		'name_admin_bar'     => _x( 'Location', 'add new on admin bar', 'your-plugin-textdomain' ),
		'add_new'            => _x( 'Add Location', 'Service', 'your-plugin-textdomain' ),
		...
		'all_items'          => __( 'All Location', 'your-plugin-textdomain' ),
		'search_items'       => __( 'Search Location', 'your-plugin-textdomain' ),
		'parent_item_colon'  => __( 'Parent Location:', 'your-plugin-textdomain' ),
	...
	$args = array(
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite'            => array( 'slug' => 'location_post' ),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
